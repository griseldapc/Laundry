    ...
    <tbody>
            ...
            <tr style="text-align: center;">
                ...
                <td>
                    ...
                    <td>
                    <a href="hapus_user.php?id_user=<?=$data_user['id_user']?>" onclick="return confirm('Apakah anda yakin menghapus data USER ini?')" class="btn btn-danger">Hapus</a>
                    </td>

...
<body class="full-wrapper">
    ...
    <main>
                            ...
                            <div class="row">
                                <div class="col-xl-9 col-lg-11 col-md-11">
                                    <div class="hero__caption">
                                        <h1 data-animation="fadeInUp" data-delay=".2s">Laundryen</h1>
                                        <div class="hero-details">
                                            <div class="stock-text" data-animation="fadeInUp" data-delay=".8s">
                                                <h2>Cleaning</h2>
                                                <h2>Cleaning</h2>
                                            </div>
                                            <P data-animation="fadeInUp" data-delay=".4s">Welcome to our website!!<br>
                                                Hope you are satisfied with our service.<br>
                                                Enjoy!</P>
                                            <!-- Hero-btn -->
                                            <div class="hero__btn">
        ...
        <section class="office-environments" >
            <div class="container">
                <div class="environments-wrapper section-bg02" data-background="assets/img/gallery/tumpuk.webp">
                    <div class="row">
                        <div class="col-xl-7 col-lg-8 offset-xl-5 offset-lg-4">
                            <div class="office-pera">
                                <div class="section-tittle">
                                    <h2 class="mb-30">About Laundryen</h2>
                                    <p>
                                        The official trusted laundry website, which has been starting a business since 2020.<br>
                                        Offers several types of laundry services<br>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat mb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                            <div class="cat-icon">
                                <img src="assets/img/icon/cuci.png" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5>100% clean</h5>
                                <p>The segregation of laundry categories is guaranteed not to fade</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat mb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                            <div class="cat-icon">
                                <img src="assets/img/icon/jemur.png" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5>Drying Machine</h5>
                                <p>Dried by machine technology and sunlight</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat mb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                            <div class="cat-icon">
                                <img src="assets/img/icon/seterika.png" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5>Ironed slowly</h5>
                                <p>Gently ironed, guaranteed not to wrinkle</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat mb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                            <div class="cat-icon">
                                <img src="assets/img/icon/lipat.png" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5>Fast, Clean, Fregrant</h5>
                                <p>Produce clothes that fast, clean, fragrant</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <img src="assets/img/gallery/cewek.webp" alt="" class="w-100">
                    </div>
                </div>
            </div>
        </div>

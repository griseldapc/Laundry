...
<header>
    ...
    <form action="proses_ubah_member.php" method="post">
        ...
        <select name="jenis_kelamin" value="<?=$dt_member['jenis_kelamin']?>" class="form-control" >
            <option></option>
            <option value="Laki - laki" <?php if ($dt_member['jenis_kelamin'] == "Laki - laki"): ?> selected="selected"<?php endif; ?>>Laki-laki</option>
            <option value="Perempuan" <?php if ($dt_member['jenis_kelamin'] == "Perempuan"): ?> selected="selected"<?php endif; ?>>Perempuan</option>
        </select>
        
        No Tlp : 
        <input type="text" name="no_tlp" value="<?=$dt_member['no_tlp']?>" class="form-control">
        <br>
